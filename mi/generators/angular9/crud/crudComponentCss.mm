...
<node CREATED="1723661398938" ID="ID_1159313010" LINK="../../../mapperidea.mm" MODIFIED="1724093519168" TEXT="crudComponentCss">
<icon BUILTIN="element"/>
<node CREATED="1723661746674" MODIFIED="1723661750506" POSITION="right" TEXT="patterns">
<icon BUILTIN="element"/>
<node CREATED="1723665125605" MODIFIED="1723665130874" TEXT="init">
<icon BUILTIN="element"/>
<node CREATED="1723665151093" MODIFIED="1723828398032" TEXT="button {&#xa;    margin-bottom: 30px;&#xa;}&#xa; ">
...
<icon BUILTIN="element"/>
<node CREATED="1723661754770" MODIFIED="1723661758775" TEXT="/classes">
<icon BUILTIN="tag_green"/>
</node>
</node>
