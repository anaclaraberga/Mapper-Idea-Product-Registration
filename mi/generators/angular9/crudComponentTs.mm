...
<node CREATED="1723580596349" ID="ID_1952041186" MODIFIED="1723646667934" POSITION="right" TEXT="parameters">
<icon BUILTIN="element"/>
...
<node CREATED="1723646632417" ID="ID_1650817107" MODIFIED="1723646850550" POSITION="right" TEXT="patterns">
<icon BUILTIN="element"/>
...
<icon BUILTIN="element"/>
<node CREATED="1723646863400" ID="ID_233863048" MODIFIED="1724093246644" TEXT="@Component({&#xa;  selector: &apos;app-{{ mi:lower-case-add-hifen(@name, &apos;&apos;) }}-crud&apos;,&#xa;  templateUrl: &apos;./{{ mi:lower-case-add-hifen(@name, &apos;&apos;) }}-crud.component.html&apos;,&#xa;  styleUrls: [&apos;./{{ mi:lower-case-add-hifen(@name, &apos;&apos;) }}-crud.component.css&apos;]&#xa;})&#xa; ">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1723652929887" MODIFIED="1723652969971" TEXT="className">
<icon BUILTIN="element"/>
<node CREATED="1723652934839" ID="ID_409363224" MODIFIED="1724093233915" TEXT="export class {{ mi:first-upper(@name) }}CrudComponent implements OnInit {&#xa; ">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1723652975183" MODIFIED="1723653137035" TEXT="constructor">
<icon BUILTIN="element"/>
<node CREATED="1723652982286" ID="ID_23269463" MODIFIED="1724093233845" TEXT="  constructor(private router: Router, private headerService: HeaderService) { &#xa;    headerService.headerData = {&#xa;      title: &apos;{{ properties/title/value }}&apos;,&#xa;      icon: &apos;{{ mi:if-else(exists(properties/icon/value), properties/icon/value, &apos;album&apos;) }}&apos;,&#xa;      routeUrl: &apos;/{{mi:first-lower(@name) }}&apos;&#xa;    }&#xa;  }&#xa; ">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1723653137871" MODIFIED="1723653176220" TEXT="ngOnInit">
<icon BUILTIN="element"/>
<node CREATED="1723653142464" ID="ID_1390551341" MODIFIED="1724093233776" TEXT="  ngOnInit(): void {&#xa;  }&#xa; ">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1723653177280" ID="ID_747011898" MODIFIED="1723653180285" TEXT="navigate">
<icon BUILTIN="element"/>
...
<node CREATED="1723653235864" ID="ID_1746735715" MODIFIED="1723653239134" TEXT="ending">
<icon BUILTIN="element"/>
...
<node CREATED="1723646616505" ID="ID_1221427018" MODIFIED="1723646619982" POSITION="right" TEXT="start">
<icon BUILTIN="element"/>
...
<node CREATED="1723580905477" ID="ID_109132922" MODIFIED="1723642093438" TEXT="body">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1723573062829" MODIFIED="1723580927986" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1723573062829" ID="ID_937081205" MODIFIED="1723580927986" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1723572907646" MODIFIED="1723653219708" TEXT="ngOnInit">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1723573062829" ID="ID_865214070" MODIFIED="1723580927986" TEXT="write-pattern">
<icon BUILTIN="element"/>
